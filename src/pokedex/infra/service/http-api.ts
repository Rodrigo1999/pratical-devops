...
type InputOutput = IInputOutput<Shared.HttpApi>

export default class HttpApi implements Shared.HttpApi{

    api
    constructor(private readonly config: Shared.HttpApiCreate){
